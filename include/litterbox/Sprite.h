...
{
public:
	Vec2d pos;				//!< Vec2d position coordinates, x and y
	...
	/*! \param _p Position coordinates for sprite
	 ...
	 */
	Sprite(Vec2d _p, int _start_frame, int _end_frame, int* _delay, graphic_t* gfx);
	 ...
	 */
	void SetupSprite(Vec2d _p, int _current_frame, int* _delay, int _palette_num);
